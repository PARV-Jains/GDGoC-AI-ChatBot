  ...
  <div className="flex flex-col items-center justify-center px-6 py-12 text-center">
    ...
    <div className="space-y-2 max-w-xs">
      ...
      <p className="text-xs text-muted-foreground leading-relaxed">
        Start a new Chat session to begin creating content with your GDGoC IET-DAVV ChatBot
      </p>
    </div>
    <div className="mt-4 flex items-center gap-1 text-xs text-muted-foreground/60">
      <span>Click "New Chat Session" to get started</span>
    </div>
  </div>
);
              ...
              Preview={(previewProps) => (
                ...
                >
                  ...
                  <span className="flex-1 truncate text-sm font-medium">
                    {previewProps.channel.data?.name || "New Chat Session"}
                  </span>
                  <Button
                    variant="ghost"
                    size="icon"
