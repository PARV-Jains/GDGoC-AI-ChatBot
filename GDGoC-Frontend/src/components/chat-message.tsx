...
const ChatMessage: React.FC = () => {
  ...
  const [copied, setCopied] = useState(false);
   ...
   // Find the first image attachment in the message
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col space-y-1">
          ...
          >
             {imageAttachment && (
              <div className="mb-2 rounded-lg overflow-hidden border bg-black/10">
                <img
                  src={imageAttachment.asset_url || imageAttachment.thumb_url}
                  alt={imageAttachment.title || "User uploaded image"}
